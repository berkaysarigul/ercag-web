...
export default function CookieConsent() {
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full bg-white border-t p-4 shadow-lg z-50 animate-in slide-in-from-bottom flex flex-col md:flex-row items-center justify-between gap-4">
