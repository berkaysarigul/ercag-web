...
export default function AuthPage() {
    ...
    return (
        <div className="min-h-[60vh] flex items-center justify-center pt-36 pb-12 px-4">
            <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-card border border-gray-100 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 bg-primary hover:bg-[#1a332a] text-white font-bold rounded-xl transition-colors shadow-md hover:shadow-lg mt-2 flex items-center justify-center"
                            disabled={loading}
                        >
