...
export default function ProfilePage() {
    ...
    return (
        <div className="container pt-36 pb-12">
            <h1 className="text-3xl font-bold text-gray-900 font-serif mb-8">Hesabım</h1>

            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {/* Sidebar */}
                <div className="md:col-span-1">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-6 bg-[#f4f4f0] border-b border-gray-200 text-center">
                            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-primary shadow-sm mx-auto mb-3">
                                <User size={32} />
                            </div>
                        ...
                        <nav className="p-2 space-y-1">
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${activeTab === 'profile' ? 'bg-primary text-white shadow-md' : 'text-gray-600 hover:bg-[#f4f4f0]'}`}
                            >
                                <User size={20} /> Profil Bilgileri
                            </button>
                            <button
                                onClick={() => setActiveTab('orders')}
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${activeTab === 'orders' ? 'bg-primary text-white shadow-md' : 'text-gray-600 hover:bg-[#f4f4f0]'}`}
                            >
                                <ShoppingBag size={20} /> Siparişlerim
                            </button>
                            <button
                                onClick={() => setActiveTab('password')}
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${activeTab === 'password' ? 'bg-primary text-white shadow-md' : 'text-gray-600 hover:bg-[#f4f4f0]'}`}
                            >
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                        {activeTab === 'profile' && (
                            <form onSubmit={handleProfileUpdate} className="space-y-6 max-w-lg">
                                ...
                                <button type="submit" className="px-6 py-2.5 bg-primary hover:bg-[#1a332a] text-white font-bold rounded-xl transition-colors shadow-sm" disabled={loading}>
